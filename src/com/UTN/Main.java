...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        AeroTaxi hangar = new AeroTaxi();
        Gold avionG = new Gold(100, 300, 10, 1000, "Caca", "1G", true, true);
        hangar.agregarAvion(avionG);
        Gold avionG2 = new Gold(100, 300, 10, 1000, "Caca", "2G", true, false);
        hangar.agregarAvion(avionG2);
        Silver avionS = new Silver(80, 200, 5, 800, "Pis", "1S", true);
        hangar.agregarAvion(avionS);
        Silver avionS2 = new Silver(80, 200, 5, 800, "Pis", "2S", true);
        hangar.agregarAvion(avionS2);
        Silver avionS3 = new Silver(80, 200, 5, 800, "Pis", "3S", true);
        hangar.agregarAvion(avionS3);
        Bronze avionB = new Bronze(60, 150, 3, 500, "Pajita", "1B");
        hangar.agregarAvion(avionB);
        Bronze avionB2 = new Bronze(60, 150, 3, 500, "Pajita", "2B");
        hangar.agregarAvion(avionB2);
        Bronze avionB3 = new Bronze(60, 150, 3, 500, "Pajita", "3B");
        hangar.agregarAvion(avionB3);
        Bronze avionB4 = new Bronze(60, 150, 3, 500, "Pajita", "4B");
        hangar.agregarAvion(avionB4);
        Bronze avionB5 = new Bronze(60, 150, 3, 500, "Pajota", "5B");
